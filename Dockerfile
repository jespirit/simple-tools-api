...
COPY simple-tools.sln .
COPY simple-tools-api/*.csproj simple-tools-api/
RUN dotnet restore simple-tools-api/simple-tools-api.csproj

# Copy the rest of the application source code
COPY . .

# Build and publish the application for release
RUN dotnet publish simple-tools-api/simple-tools-api.csproj -c Release -o /app/publish --no-restore
